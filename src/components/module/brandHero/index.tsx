...
const BrandHero: React.FC<BrandHeroProps> = ({ banners, bannerType }) => {
  ...
  return (
    <div className={`${styles.brandHero} ${containerClass}`}>
      ...
      {activeBanner && (
        <div className={styles.bannerItem}>
          ...
          <div className={`${styles.textContainer} ${styles[alignmentClass]}`}>
