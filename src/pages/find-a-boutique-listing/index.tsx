  ...
  useEffect(() => {
    const fetchStores = async () => {
      try {
        ...
        const filteredDubaiStores = result.filter(store => store.city.toLowerCase() === 'dubai');
        const filteredAbuDhabiStores = result.filter(store => store.city.toLowerCase() === 'abu dhabi');
        ...
        <div className={styles.tabsSwiperContainer}>
          ...
          <Swiper slidesPerView={"auto"} className={styles.tabsSwiper}>
            <SwiperSlide className={styles.tabsSwiperSlide}>
              <button onClick={() => handleTabChange('All')} className={`${[styles.tabButton]} ${activeTab.toLowerCase() === 'all' ? styles.active : ''}`}>
                All Boutiques
              </button>
            </SwiperSlide>
            <SwiperSlide className={styles.tabsSwiperSlide}>
              <button onClick={() => handleTabChange('Dubai')} className={`${[styles.tabButton]} ${activeTab.toLowerCase() === 'dubai' ? styles.active : ''}`}>
                Dubai
              </button>
            </SwiperSlide>
            <SwiperSlide className={styles.tabsSwiperSlide}>
              <button onClick={() => handleTabChange('Abu Dhabi')} className={`${[styles.tabButton]} ${activeTab.toLowerCase() === 'abu dhabi' ? styles.active : ''}`}>
                Abu Dhabi
              </button>
            </SwiperSlide>
          </Swiper>
